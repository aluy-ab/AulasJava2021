...
public class ViewManterPessoa extends JDialog {
	...
	public ViewManterPessoa(Controller ctrl) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(ViewManterPessoa.class.getResource("/resource/plus2.png")));
		this.ctrl = ctrl;
		...
		gbl_contentPanel.columnWidths = new int[]{0, 74, 0, 0};
		...
		fieldnome.setColumns(10);
		{
			...
			btnExcluir.setIcon(new ImageIcon(ViewManterPessoa.class.getResource("/resource/remove.png")));
			...
			btnSalvar.setIcon(new ImageIcon(ViewManterPessoa.class.getResource("/resource/save.png")));
			btnSalvar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					/*} catch (Exception e) {
						JOptionPane.showMessageDialog(ViewManterPessoa.this, e.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
			...
			btnFechar.setIcon(new ImageIcon(ViewManterPessoa.class.getResource("/resource/exit2.png")));
