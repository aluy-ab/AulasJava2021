...
public class ViewMainWindow {
	...
	private void initialize() {
		...
		JMenuItem mntmConsultarPessoa = new JMenuItem("Consultar pessoas...");
		mntmConsultarPessoa.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new ControllerPessoa(frame);
			}
		});
		mntmConsultarPessoa.setIcon(new ImageIcon(ViewMainWindow.class.getResource("/resources/edit.png")));
